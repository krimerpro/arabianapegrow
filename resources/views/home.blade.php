            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="banner-content pt-5">
                        ...
                        <div class="mt-5">
                            <a href="https://exchange.pancakeswap.finance/#/swap?inputCurrency=0x9DE60b3570a9c534565B0CBa999aacd9e9a4bacc" target="_blank" class="btn btn-lg btn-gradient-purple btn-glow mr-4 mb-2 animated" data-animation="fadeInUpShorter" data-animation-delay="1.7s">Buy on PancakeSwap</a>
                            <a href="https://bscscan.com/token/0x9DE60b3570a9c534565B0CBa999aacd9e9a4bacc" class="btn btn-lg btn-gradient-purple btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s">BscScan Info</a>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="col-md-9 col-lg-9">
                      ...
                      <div style="-webkit-box-shadow: 0px 28px 28px -24px rgb(56 62 86 / 25%);box-shadow: 0px 28px 28px -24px rgb(56 62 86 / 25%);border-radius: 12px;padding: 16px 20px;text-decoration: none !important;display: block;">
                          <div class="text-center">
                            <input type="text" value="0x9DE60b3570a9c534565B0CBa999aacd9e9a4bacc" id="smartcontractaddress" readonly style="width:100%;text-align:center;color:#ffffff;background:none;border:none" />
                          </div>
